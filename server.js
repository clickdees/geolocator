        ...
        if(storesJson[source]){
          //found
            ...
            if(geo){
              ...
              let geoData = { country: isoCode, currency: currency, symbol: currencySymbols[currency] };
              console.log(geoData);
          ...
          res.status(200).json({ country: "ERR", currency: "HKD",symbol: "$"  });
        }
    })
    .catch((err) => {
        // console.error(err);
