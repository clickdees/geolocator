...
const geolocationAPI2 = "https://jeweled-grateful-driver.glitch.me"; // , https://mc-checkouts-geo-server-2.herokuapp.com, https://funny-nine-toy.glitch.me
...
app.post("/api/country", function(req, res) {
  ...
  requestify.request(geolocationAPI2 + '/api/load-db-file', {
            method: 'GET',
            headers: {
